...
void HHTo2B2GNtupler::Analyze(bool isData, int Option, string outputfilename, string year, string pileupWeightName)
{
    ...
    float pho1Eta = -99;
    float pho1Phi = -99;
    int pho1_cutBasedBitmap = -99;
    int pho1_mvaID = -99;
    bool pho1_electronVeto = -99;
    bool pho1_pixelSeed = -99;
    bool pho1_mvaID_WP80 = -99;
    bool pho1_mvaID_WP90 = -99;
    int  pho1_pdgId = -99;
    float pho2Pt = -99;
    float pho2Eta = -99;
    float pho2Phi = -99;
    int pho2_cutBasedBitmap = -99;
    int pho2_mvaID = -99;
    bool pho2_electronVeto = -99;
    bool pho2_pixelSeed = -99;
    bool pho2_mvaID_WP80 = -99;
    bool pho2_mvaID_WP90 = -99;
    int  pho2_pdgId = -99;
    float jet1Pt = -99;
    float jet1Eta = -99;
    float jet1Phi = -99;
