...
double HHHTo6BNtupler::getTriggerEff3D( TH2F *triggerEffHist_Xbb0p0To0p9, 
...
double HHHTo6BNtupler::getTriggerEff( TH2F *trigEffHist , double pt, double mass ) {
  double result = 0.0;
  double tmpMass = 0;
  double tmpPt = 0;
...
void HHHTo6BNtupler::Analyze(bool isData, int Option, string outputfilename, string year, string pileupWeightName)
{
	...
	cout << "[HHHTo6BNtupler] Warning: year " << year << " is not supported. \n";
      }
    ...
    if (outfilename == "") outfilename = "HHHTo6BNtuple.root";
    ...
    float genHiggs3Pt = -1;
    float genHiggs3Eta = -1;
    float genHiggs3Phi = -1;
    float genHiggs1Daughter1Pt = -1;
    float genHiggs1Daughter1Eta = -1;
    float genHiggs1Daughter1Phi = -1;
    float genHiggs1Daughter2Pt = -1;
    float genHiggs1Daughter2Eta = -1;
    float genHiggs1Daughter2Phi = -1;
    float genHiggs2Daughter1Pt = -1;
    float genHiggs2Daughter1Eta = -1;
    float genHiggs2Daughter1Phi = -1;
    float genHiggs2Daughter2Pt = -1;
    float genHiggs2Daughter2Eta = -1;
    float genHiggs2Daughter2Phi = -1;
    float genHiggs3Daughter1Pt = -1;
    float genHiggs3Daughter1Eta = -1;
    float genHiggs3Daughter1Phi = -1;
    float genHiggs3Daughter2Pt = -1;
    float genHiggs3Daughter2Eta = -1;
    float genHiggs3Daughter2Phi = -1;
    float genHHH_pt = -99;
    float genHHH_eta = -99;
    float genHHH_phi = -99;
    float genHHH_mass = -99;
    float genWPt = -1;
    float genWEta = -1;
    float genWPhi = -1;
    float genZPt = -1;
    ...
    if (Option != 20 && Option != 100) {
      ...
      outputTree->Branch("genHiggs3Pt", &genHiggs3Pt, "genHiggs3Pt/F");
      outputTree->Branch("genHiggs3Eta", &genHiggs3Eta, "genHiggs3Eta/F");
      outputTree->Branch("genHiggs3Phi", &genHiggs3Phi, "genHiggs3Phi/F");
      outputTree->Branch("genHiggs1Daughter1Pt", &genHiggs1Daughter1Pt, "genHiggs1Daughter1Pt/F");
      outputTree->Branch("genHiggs1Daughter1Eta", &genHiggs1Daughter1Eta, "genHiggs1Daughter1Eta/F");
      outputTree->Branch("genHiggs1Daughter1Phi", &genHiggs1Daughter1Phi, "genHiggs1Daughter1Phi/F");
      outputTree->Branch("genHiggs1Daughter2Pt", &genHiggs1Daughter2Pt, "genHiggs1Daughter2Pt/F");
      outputTree->Branch("genHiggs1Daughter2Eta", &genHiggs1Daughter2Eta, "genHiggs1Daughter2Eta/F");
      outputTree->Branch("genHiggs1Daughter2Phi", &genHiggs1Daughter2Phi, "genHiggs1Daughter2Phi/F");
      outputTree->Branch("genHiggs2Daughter1Pt", &genHiggs2Daughter1Pt, "genHiggs2Daughter1Pt/F");
      outputTree->Branch("genHiggs2Daughter1Eta", &genHiggs2Daughter1Eta, "genHiggs2Daughter1Eta/F");
      outputTree->Branch("genHiggs2Daughter1Phi", &genHiggs2Daughter1Phi, "genHiggs2Daughter1Phi/F");
      outputTree->Branch("genHiggs2Daughter2Pt", &genHiggs2Daughter2Pt, "genHiggs2Daughter2Pt/F");
      outputTree->Branch("genHiggs2Daughter2Eta", &genHiggs2Daughter2Eta, "genHiggs2Daughter2Eta/F");
      outputTree->Branch("genHiggs2Daughter2Phi", &genHiggs2Daughter2Phi, "genHiggs2Daughter2Phi/F");
      outputTree->Branch("genHiggs3Daughter1Pt", &genHiggs3Daughter1Pt, "genHiggs3Daughter1Pt/F");
      outputTree->Branch("genHiggs3Daughter1Eta", &genHiggs3Daughter1Eta, "genHiggs3Daughter1Eta/F");
      outputTree->Branch("genHiggs3Daughter1Phi", &genHiggs3Daughter1Phi, "genHiggs3Daughter1Phi/F");
      outputTree->Branch("genHiggs3Daughter2Pt", &genHiggs3Daughter2Pt, "genHiggs3Daughter2Pt/F");
      outputTree->Branch("genHiggs3Daughter2Eta", &genHiggs3Daughter2Eta, "genHiggs3Daughter2Eta/F");
      outputTree->Branch("genHiggs3Daughter2Phi", &genHiggs3Daughter2Phi, "genHiggs3Daughter2Phi/F");
      outputTree->Branch("genHHH_pt",      &genHHH_pt,     "genHHH_pt/F");
      outputTree->Branch("genHHH_eta",     &genHHH_eta,    "genHHH_eta/F");
      outputTree->Branch("genHHH_phi",     &genHHH_phi,    "genHHH_phi/F");
      outputTree->Branch("genHHH_mass",    &genHHH_mass,   "genHHH_mass/F");
    ...
    for (UInt_t jentry=0; jentry<nentries;jentry++) {
      ...
      genHiggs3Eta = -99.0;
      genHiggs3Phi = -99.0;
      genHiggs1Daughter1Pt = -99.0;
      genHiggs1Daughter1Eta = -99.0;
      genHiggs1Daughter1Phi = -99.0;
      genHiggs1Daughter2Pt = -99.0;
      genHiggs1Daughter2Eta = -99.0;
      genHiggs1Daughter2Phi = -99.0;
      genHiggs2Daughter1Pt = -99.0;
      genHiggs2Daughter1Eta = -99.0;
      genHiggs2Daughter1Phi = -99.0;
      genHiggs2Daughter2Pt = -99.0;
      genHiggs2Daughter2Eta = -99.0;
      genHiggs2Daughter2Phi = -99.0;
      genHiggs3Daughter1Pt = -99.0;
      genHiggs3Daughter1Eta = -99.0;
      genHiggs3Daughter1Phi = -99.0;
      genHiggs3Daughter2Pt = -99.0;
      genHiggs3Daughter2Eta = -99.0;
      genHiggs3Daughter2Phi = -99.0;
      genHHH_pt = -99;
      genHHH_eta = -99;
      genHHH_phi = -99;
      genHHH_mass = -99;   
	...
	genJetPhi[i] = GenJet_phi[i];
 	...
 	genJetPartonFlavor[i] = GenJet_partonFlavour[i];
      ...
      std::vector< int > genHiggsIndexVector;
      if (!isData) {
	...
	for(int i = 0; i < nGenPart; i++) {
	  if( abs(GenPart_pdgId[i]) == 5  && GenPart_pdgId[GenPart_genPartIdxMother[i]] == 25 && current_mIndex != GenPart_genPartIdxMother[i] ) {
	    ...
	    genHiggsIndexVector.push_back(GenPart_genPartIdxMother[i]);
	...
	if(genHiggsVector.size() >= 3) {
	  genHiggs3Pt = genHiggsVector[2].Pt();
	  genHiggs3Eta = genHiggsVector[2].Eta();
	  genHiggs3Phi = genHiggsVector[2].Phi();	
	}
	
	//gen level
	if(genHiggsVector.size() > 2) { 
	  genHHH_pt = (genHiggsVector[0]+genHiggsVector[1]+genHiggsVector[2]).Pt();
	  genHHH_eta = (genHiggsVector[0]+genHiggsVector[1]+genHiggsVector[2]).Eta();
	  genHHH_phi = (genHiggsVector[0]+genHiggsVector[1]+genHiggsVector[2]).Phi();
	  genHHH_mass= (genHiggsVector[0]+genHiggsVector[1]+genHiggsVector[2]).M();
	}

	//Get Higgs Daughters
	for (int k=0; k<genHiggsIndexVector.size(); k++) {
	  
	  bool foundFirstDaughter = false;
	  bool foundSecondDaughter = false;
	  for(int i = 0; i < nGenPart; i++) {
	    if( abs(GenPart_pdgId[i]) == 5  && GenPart_genPartIdxMother[i] == genHiggsIndexVector[k] ) {
	      if (!foundFirstDaughter) {
		if (k==0) {
		  genHiggs1Daughter1Pt = GenPart_pt[i];
		  genHiggs1Daughter1Eta = GenPart_eta[i];
		  genHiggs1Daughter1Phi = GenPart_phi[i];
		} else if (k==1) {
		  genHiggs2Daughter1Pt = GenPart_pt[i];
		  genHiggs2Daughter1Eta = GenPart_eta[i];
		  genHiggs2Daughter1Phi = GenPart_phi[i];
		} else if (k==2) {
		  genHiggs3Daughter1Pt = GenPart_pt[i];
		  genHiggs3Daughter1Eta = GenPart_eta[i];
		  genHiggs3Daughter1Phi = GenPart_phi[i];
		}
		foundFirstDaughter = true;
	      } else {
		if (!foundSecondDaughter) {
		  if (k==0) {
		    genHiggs1Daughter2Pt = GenPart_pt[i];
		    genHiggs1Daughter2Eta = GenPart_eta[i];
		    genHiggs1Daughter2Phi = GenPart_phi[i];
		  } else if (k==1) {
		    genHiggs2Daughter2Pt = GenPart_pt[i];
		    genHiggs2Daughter2Eta = GenPart_eta[i];
		    genHiggs2Daughter2Phi = GenPart_phi[i];
		  } else if (k==2) {
		    genHiggs3Daughter2Pt = GenPart_pt[i];
		    genHiggs3Daughter2Eta = GenPart_eta[i];
		    genHiggs3Daughter2Phi = GenPart_phi[i];
		  }
		  foundSecondDaughter = true;
		} else {
		  break;
		}
	      }	      
	    } //if found higgs daughter
	  } //loop over gen particles
	} //loop over gen Higgs particles
