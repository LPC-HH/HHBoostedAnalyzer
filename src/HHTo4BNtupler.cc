...
void HHTo4BNtupler::Analyze(bool isData, string outputfilename, string year)
{
    ...
    float fatJet1_globalParT3_QCD = -99;
    float fatJet1_globalParT3_TopbWev = -99;
    float fatJet1_globalParT3_TopbWmv = -99;
    float fatJet1_globalParT3_TopbWq = -99;
    float fatJet1_globalParT3_TopbWqq = -99;
    float fatJet1_globalParT3_TopbWtauhv = -99;
    float fatJet1_globalParT3_WvsQCD = -99;
    float fatJet1_globalParT3_XWW3q = -99;
    float fatJet1_globalParT3_XWW4q = -99;
    float fatJet1_globalParT3_XWWqqev = -99;
    float fatJet1_globalParT3_XWWqqmv = -99;
    float fatJet1_globalParT3_Xbb = -99;
    float fatJet1_globalParT3_Xcc = -99;
    float fatJet1_globalParT3_Xcs = -99;
    float fatJet1_globalParT3_Xqq = -99;
    float fatJet1_globalParT3_Xtauhtaue = -99;
    float fatJet1_globalParT3_Xtauhtauh = -99;
    float fatJet1_globalParT3_Xtauhtaum = -99;
    float fatJet1_globalParT3_massCorrGeneric = -99;
    float fatJet1_globalParT3_massCorrX2p = -99;
    float fatJet1_globalParT3_withMassTopvsQCD = -99;
    float fatJet1_globalParT3_withMassWvsQCD = -99;
    float fatJet1_globalParT3_withMassZvsQCD = -99;
    ...
    float fatJet2_globalParT3_QCD = -99;
    float fatJet2_globalParT3_TopbWev = -99;
    float fatJet2_globalParT3_TopbWmv = -99;
    float fatJet2_globalParT3_TopbWq = -99;
    float fatJet2_globalParT3_TopbWqq = -99;
    float fatJet2_globalParT3_TopbWtauhv = -99;
    float fatJet2_globalParT3_WvsQCD = -99;
    float fatJet2_globalParT3_XWW3q = -99;
    float fatJet2_globalParT3_XWW4q = -99;
    float fatJet2_globalParT3_XWWqqev = -99;
    float fatJet2_globalParT3_XWWqqmv = -99;
    float fatJet2_globalParT3_Xbb = -99;
    float fatJet2_globalParT3_Xcc = -99;
    float fatJet2_globalParT3_Xcs = -99;
    float fatJet2_globalParT3_Xqq = -99;
    float fatJet2_globalParT3_Xtauhtaue = -99;
    float fatJet2_globalParT3_Xtauhtauh = -99;
    float fatJet2_globalParT3_Xtauhtaum = -99;
    float fatJet2_globalParT3_massCorrGeneric = -99;
    float fatJet2_globalParT3_massCorrX2p = -99;
    float fatJet2_globalParT3_withMassTopvsQCD = -99;
    float fatJet2_globalParT3_withMassWvsQCD = -99;
    float fatJet2_globalParT3_withMassZvsQCD = -99;
    ...
    float fatJet3_globalParT3_QCD = -99;
    float fatJet3_globalParT3_TopbWev = -99;
    float fatJet3_globalParT3_TopbWmv = -99;
    float fatJet3_globalParT3_TopbWq = -99;
    float fatJet3_globalParT3_TopbWqq = -99;
    float fatJet3_globalParT3_TopbWtauhv = -99;
    float fatJet3_globalParT3_WvsQCD = -99;
    float fatJet3_globalParT3_XWW3q = -99;
    float fatJet3_globalParT3_XWW4q = -99;
    float fatJet3_globalParT3_XWWqqev = -99;
    float fatJet3_globalParT3_XWWqqmv = -99;
    float fatJet3_globalParT3_Xbb = -99;
    float fatJet3_globalParT3_Xcc = -99;
    float fatJet3_globalParT3_Xcs = -99;
    float fatJet3_globalParT3_Xqq = -99;
    float fatJet3_globalParT3_Xtauhtaue = -99;
    float fatJet3_globalParT3_Xtauhtauh = -99;
    float fatJet3_globalParT3_Xtauhtaum = -99;
    float fatJet3_globalParT3_massCorrGeneric = -99;
    float fatJet3_globalParT3_massCorrX2p = -99;
    float fatJet3_globalParT3_withMassTopvsQCD = -99;
    float fatJet3_globalParT3_withMassWvsQCD = -99;
    float fatJet3_globalParT3_withMassZvsQCD = -99;    float fatJet3_phi = -99;
    float fatJet3_pt = -99;
...
///////////////////////////////////////////////////////////////////////////
    ...
    outputTree->Branch("fatJet1_globalParT3_QCD" , &fatJet1_globalParT3_QCD, "fatJet1_globalParT3_QCD/F");		     
    outputTree->Branch("fatJet1_globalParT3_TopbWev" , &fatJet1_globalParT3_TopbWev, "fatJet1_globalParT3_TopbWev/F");	     
    outputTree->Branch("fatJet1_globalParT3_TopbWmv" , &fatJet1_globalParT3_TopbWmv, "fatJet1_globalParT3_TopbWmv/F");	     
    outputTree->Branch("fatJet1_globalParT3_TopbWq" , &fatJet1_globalParT3_TopbWq, "fatJet1_globalParT3_TopbWq/F");	     
    outputTree->Branch("fatJet1_globalParT3_TopbWqq" , &fatJet1_globalParT3_TopbWqq, "fatJet1_globalParT3_TopbWqq/F");	     
    outputTree->Branch("fatJet1_globalParT3_TopbWtauhv" , &fatJet1_globalParT3_TopbWtauhv, "fatJet1_globalParT3_TopbWtauhv/F");	     
    outputTree->Branch("fatJet1_globalParT3_WvsQCD" , &fatJet1_globalParT3_WvsQCD, "fatJet1_globalParT3_WvsQCD/F");	     
    outputTree->Branch("fatJet1_globalParT3_XWW3q" , &fatJet1_globalParT3_XWW3q, "fatJet1_globalParT3_XWW3q/F");	     
    outputTree->Branch("fatJet1_globalParT3_XWW4q" , &fatJet1_globalParT3_XWW4q, "fatJet1_globalParT3_XWW4q/F");	     
    outputTree->Branch("fatJet1_globalParT3_XWWqqev" , &fatJet1_globalParT3_XWWqqev, "fatJet1_globalParT3_XWWqqev/F");	     
    outputTree->Branch("fatJet1_globalParT3_XWWqqmv" , &fatJet1_globalParT3_XWWqqmv, "fatJet1_globalParT3_XWWqqmv/F");	     
    outputTree->Branch("fatJet1_globalParT3_Xbb" , &fatJet1_globalParT3_Xbb, "fatJet1_globalParT3_Xbb/F");		     
    outputTree->Branch("fatJet1_globalParT3_Xcc" , &fatJet1_globalParT3_Xcc, "fatJet1_globalParT3_Xcc/F");		     
    outputTree->Branch("fatJet1_globalParT3_Xcs" , &fatJet1_globalParT3_Xcs, "fatJet1_globalParT3_Xcs/F");		     
    outputTree->Branch("fatJet1_globalParT3_Xqq" , &fatJet1_globalParT3_Xqq, "fatJet1_globalParT3_Xqq/F");		     
    outputTree->Branch("fatJet1_globalParT3_Xtauhtaue" , &fatJet1_globalParT3_Xtauhtaue, "fatJet1_globalParT3_Xtauhtaue/F");	     
    outputTree->Branch("fatJet1_globalParT3_Xtauhtauh" , &fatJet1_globalParT3_Xtauhtauh, "fatJet1_globalParT3_Xtauhtauh/F");	     
    outputTree->Branch("fatJet1_globalParT3_Xtauhtaum" , &fatJet1_globalParT3_Xtauhtaum, "fatJet1_globalParT3_Xtauhtaum/F");	     
    outputTree->Branch("fatJet1_globalParT3_massCorrGeneric" , &fatJet1_globalParT3_massCorrGeneric, "fatJet1_globalParT3_massCorrGeneric/F");  
    outputTree->Branch("fatJet1_globalParT3_massCorrX2p" , &fatJet1_globalParT3_massCorrX2p, "fatJet1_globalParT3_massCorrX2p/F");	     
    outputTree->Branch("fatJet1_globalParT3_withMassTopvsQCD" , &fatJet1_globalParT3_withMassTopvsQCD, "fatJet1_globalParT3_withMassTopvsQCD/F"); 
    outputTree->Branch("fatJet1_globalParT3_withMassWvsQCD" , &fatJet1_globalParT3_withMassWvsQCD, "fatJet1_globalParT3_withMassWvsQCD/F");   
    outputTree->Branch("fatJet1_globalParT3_withMassZvsQCD" , &fatJet1_globalParT3_withMassZvsQCD, "fatJet1_globalParT3_withMassZvsQCD/F");
    ...
    outputTree->Branch("fatJet2_globalParT3_QCD" , &fatJet2_globalParT3_QCD, "fatJet2_globalParT3_QCD/F");		     
    outputTree->Branch("fatJet2_globalParT3_TopbWev" , &fatJet2_globalParT3_TopbWev, "fatJet2_globalParT3_TopbWev/F");	     
    outputTree->Branch("fatJet2_globalParT3_TopbWmv" , &fatJet2_globalParT3_TopbWmv, "fatJet2_globalParT3_TopbWmv/F");	     
    outputTree->Branch("fatJet2_globalParT3_TopbWq" , &fatJet2_globalParT3_TopbWq, "fatJet2_globalParT3_TopbWq/F");	     
    outputTree->Branch("fatJet2_globalParT3_TopbWqq" , &fatJet2_globalParT3_TopbWqq, "fatJet2_globalParT3_TopbWqq/F");	     
    outputTree->Branch("fatJet2_globalParT3_TopbWtauhv" , &fatJet2_globalParT3_TopbWtauhv, "fatJet2_globalParT3_TopbWtauhv/F");	     
    outputTree->Branch("fatJet2_globalParT3_WvsQCD" , &fatJet2_globalParT3_WvsQCD, "fatJet2_globalParT3_WvsQCD/F");	     
    outputTree->Branch("fatJet2_globalParT3_XWW3q" , &fatJet2_globalParT3_XWW3q, "fatJet2_globalParT3_XWW3q/F");	     
    outputTree->Branch("fatJet2_globalParT3_XWW4q" , &fatJet2_globalParT3_XWW4q, "fatJet2_globalParT3_XWW4q/F");	     
    outputTree->Branch("fatJet2_globalParT3_XWWqqev" , &fatJet2_globalParT3_XWWqqev, "fatJet2_globalParT3_XWWqqev/F");	     
    outputTree->Branch("fatJet2_globalParT3_XWWqqmv" , &fatJet2_globalParT3_XWWqqmv, "fatJet2_globalParT3_XWWqqmv/F");	     
    outputTree->Branch("fatJet2_globalParT3_Xbb" , &fatJet2_globalParT3_Xbb, "fatJet2_globalParT3_Xbb/F");		     
    outputTree->Branch("fatJet2_globalParT3_Xcc" , &fatJet2_globalParT3_Xcc, "fatJet2_globalParT3_Xcc/F");		     
    outputTree->Branch("fatJet2_globalParT3_Xcs" , &fatJet2_globalParT3_Xcs, "fatJet2_globalParT3_Xcs/F");		     
    outputTree->Branch("fatJet2_globalParT3_Xqq" , &fatJet2_globalParT3_Xqq, "fatJet2_globalParT3_Xqq/F");		     
    outputTree->Branch("fatJet2_globalParT3_Xtauhtaue" , &fatJet2_globalParT3_Xtauhtaue, "fatJet2_globalParT3_Xtauhtaue/F");	     
    outputTree->Branch("fatJet2_globalParT3_Xtauhtauh" , &fatJet2_globalParT3_Xtauhtauh, "fatJet2_globalParT3_Xtauhtauh/F");	     
    outputTree->Branch("fatJet2_globalParT3_Xtauhtaum" , &fatJet2_globalParT3_Xtauhtaum, "fatJet2_globalParT3_Xtauhtaum/F");	     
    outputTree->Branch("fatJet2_globalParT3_massCorrGeneric" , &fatJet2_globalParT3_massCorrGeneric, "fatJet2_globalParT3_massCorrGeneric/F");  
    outputTree->Branch("fatJet2_globalParT3_massCorrX2p" , &fatJet2_globalParT3_massCorrX2p, "fatJet2_globalParT3_massCorrX2p/F");	     
    outputTree->Branch("fatJet2_globalParT3_withMassTopvsQCD" , &fatJet2_globalParT3_withMassTopvsQCD, "fatJet2_globalParT3_withMassTopvsQCD/F"); 
    outputTree->Branch("fatJet2_globalParT3_withMassWvsQCD" , &fatJet2_globalParT3_withMassWvsQCD, "fatJet2_globalParT3_withMassWvsQCD/F");   
    outputTree->Branch("fatJet2_globalParT3_withMassZvsQCD" , &fatJet2_globalParT3_withMassZvsQCD, "fatJet2_globalParT3_withMassZvsQCD/F");
    ...
    outputTree->Branch("fatJet3_globalParT3_QCD" , &fatJet3_globalParT3_QCD, "fatJet3_globalParT3_QCD/F");		     
    outputTree->Branch("fatJet3_globalParT3_TopbWev" , &fatJet3_globalParT3_TopbWev, "fatJet3_globalParT3_TopbWev/F");	     
    outputTree->Branch("fatJet3_globalParT3_TopbWmv" , &fatJet3_globalParT3_TopbWmv, "fatJet3_globalParT3_TopbWmv/F");	     
    outputTree->Branch("fatJet3_globalParT3_TopbWq" , &fatJet3_globalParT3_TopbWq, "fatJet3_globalParT3_TopbWq/F");	     
    outputTree->Branch("fatJet3_globalParT3_TopbWqq" , &fatJet3_globalParT3_TopbWqq, "fatJet3_globalParT3_TopbWqq/F");	     
    outputTree->Branch("fatJet3_globalParT3_TopbWtauhv" , &fatJet3_globalParT3_TopbWtauhv, "fatJet3_globalParT3_TopbWtauhv/F");	     
    outputTree->Branch("fatJet3_globalParT3_WvsQCD" , &fatJet3_globalParT3_WvsQCD, "fatJet3_globalParT3_WvsQCD/F");	     
    outputTree->Branch("fatJet3_globalParT3_XWW3q" , &fatJet3_globalParT3_XWW3q, "fatJet3_globalParT3_XWW3q/F");	     
    outputTree->Branch("fatJet3_globalParT3_XWW4q" , &fatJet3_globalParT3_XWW4q, "fatJet3_globalParT3_XWW4q/F");	     
    outputTree->Branch("fatJet3_globalParT3_XWWqqev" , &fatJet3_globalParT3_XWWqqev, "fatJet3_globalParT3_XWWqqev/F");	     
    outputTree->Branch("fatJet3_globalParT3_XWWqqmv" , &fatJet3_globalParT3_XWWqqmv, "fatJet3_globalParT3_XWWqqmv/F");	     
    outputTree->Branch("fatJet3_globalParT3_Xbb" , &fatJet3_globalParT3_Xbb, "fatJet3_globalParT3_Xbb/F");		     
    outputTree->Branch("fatJet3_globalParT3_Xcc" , &fatJet3_globalParT3_Xcc, "fatJet3_globalParT3_Xcc/F");		     
    outputTree->Branch("fatJet3_globalParT3_Xcs" , &fatJet3_globalParT3_Xcs, "fatJet3_globalParT3_Xcs/F");		     
    outputTree->Branch("fatJet3_globalParT3_Xqq" , &fatJet3_globalParT3_Xqq, "fatJet3_globalParT3_Xqq/F");		     
    outputTree->Branch("fatJet3_globalParT3_Xtauhtaue" , &fatJet3_globalParT3_Xtauhtaue, "fatJet3_globalParT3_Xtauhtaue/F");	     
    outputTree->Branch("fatJet3_globalParT3_Xtauhtauh" , &fatJet3_globalParT3_Xtauhtauh, "fatJet3_globalParT3_Xtauhtauh/F");	     
    outputTree->Branch("fatJet3_globalParT3_Xtauhtaum" , &fatJet3_globalParT3_Xtauhtaum, "fatJet3_globalParT3_Xtauhtaum/F");	     
    outputTree->Branch("fatJet3_globalParT3_massCorrGeneric" , &fatJet3_globalParT3_massCorrGeneric, "fatJet3_globalParT3_massCorrGeneric/F");  
    outputTree->Branch("fatJet3_globalParT3_massCorrX2p" , &fatJet3_globalParT3_massCorrX2p, "fatJet3_globalParT3_massCorrX2p/F");	     
    outputTree->Branch("fatJet3_globalParT3_withMassTopvsQCD" , &fatJet3_globalParT3_withMassTopvsQCD, "fatJet3_globalParT3_withMassTopvsQCD/F"); 
    outputTree->Branch("fatJet3_globalParT3_withMassWvsQCD" , &fatJet3_globalParT3_withMassWvsQCD, "fatJet3_globalParT3_withMassWvsQCD/F");   
    outputTree->Branch("fatJet3_globalParT3_withMassZvsQCD" , &fatJet3_globalParT3_withMassZvsQCD, "fatJet3_globalParT3_withMassZvsQCD/F");
...
*/
	...
	genPhotonPhi = -1;
      */
      ...
      fatJet1_globalParT3_QCD = -99;
      fatJet1_globalParT3_TopbWev = -99;
      fatJet1_globalParT3_TopbWmv = -99;
      fatJet1_globalParT3_TopbWq = -99;
      fatJet1_globalParT3_TopbWqq = -99;
      fatJet1_globalParT3_TopbWtauhv = -99;
      fatJet1_globalParT3_WvsQCD = -99;
      fatJet1_globalParT3_XWW3q = -99;
      fatJet1_globalParT3_XWW4q = -99;
      fatJet1_globalParT3_XWWqqev = -99;
      fatJet1_globalParT3_XWWqqmv = -99;
      fatJet1_globalParT3_Xbb = -99;
      fatJet1_globalParT3_Xcc = -99;
      fatJet1_globalParT3_Xcs = -99;
      fatJet1_globalParT3_Xqq = -99;
      fatJet1_globalParT3_Xtauhtaue = -99;
      fatJet1_globalParT3_Xtauhtauh = -99;
      fatJet1_globalParT3_Xtauhtaum = -99;
      fatJet1_globalParT3_massCorrGeneric = -99;
      fatJet1_globalParT3_massCorrX2p = -99;
      fatJet1_globalParT3_withMassTopvsQCD = -99;
      fatJet1_globalParT3_withMassWvsQCD = -99;
      fatJet1_globalParT3_withMassZvsQCD = -99;
      fatJet1_phi = -99;
      fatJet1_pt = -99;
      ...
      fatJet2_globalParT3_QCD = -99;
      fatJet2_globalParT3_TopbWev = -99;
      fatJet2_globalParT3_TopbWmv = -99;
      fatJet2_globalParT3_TopbWq = -99;
      fatJet2_globalParT3_TopbWqq = -99;
      fatJet2_globalParT3_TopbWtauhv = -99;
      fatJet2_globalParT3_WvsQCD = -99;
      fatJet2_globalParT3_XWW3q = -99;
      fatJet2_globalParT3_XWW4q = -99;
      fatJet2_globalParT3_XWWqqev = -99;
      fatJet2_globalParT3_XWWqqmv = -99;
      fatJet2_globalParT3_Xbb = -99;
      fatJet2_globalParT3_Xcc = -99;
      fatJet2_globalParT3_Xcs = -99;
      fatJet2_globalParT3_Xqq = -99;
      fatJet2_globalParT3_Xtauhtaue = -99;
      fatJet2_globalParT3_Xtauhtauh = -99;
      fatJet2_globalParT3_Xtauhtaum = -99;
      fatJet2_globalParT3_massCorrGeneric = -99;
      fatJet2_globalParT3_massCorrX2p = -99;
      fatJet2_globalParT3_withMassTopvsQCD = -99;
      fatJet2_globalParT3_withMassWvsQCD = -99;
      fatJet2_globalParT3_withMassZvsQCD = -99;
      fatJet2_phi = -99;
      fatJet2_pt = -99;
      ...
      fatJet3_globalParT3_QCD = -99;
      fatJet3_globalParT3_TopbWev = -99;
      fatJet3_globalParT3_TopbWmv = -99;
      fatJet3_globalParT3_TopbWq = -99;
      fatJet3_globalParT3_TopbWqq = -99;
      fatJet3_globalParT3_TopbWtauhv = -99;
      fatJet3_globalParT3_WvsQCD = -99;
      fatJet3_globalParT3_XWW3q = -99;
      fatJet3_globalParT3_XWW4q = -99;
      fatJet3_globalParT3_XWWqqev = -99;
      fatJet3_globalParT3_XWWqqmv = -99;
      fatJet3_globalParT3_Xbb = -99;
      fatJet3_globalParT3_Xcc = -99;
      fatJet3_globalParT3_Xcs = -99;
      fatJet3_globalParT3_Xqq = -99;
      fatJet3_globalParT3_Xtauhtaue = -99;
      fatJet3_globalParT3_Xtauhtauh = -99;
      fatJet3_globalParT3_Xtauhtaum = -99;
      fatJet3_globalParT3_massCorrGeneric = -99;
      fatJet3_globalParT3_massCorrX2p = -99;
      fatJet3_globalParT3_withMassTopvsQCD = -99;
      fatJet3_globalParT3_withMassWvsQCD = -99;
      fatJet3_globalParT3_withMassZvsQCD = -99;
      fatJet3_phi = -99;
      fatJet3_pt = -99;
      ...
      //cout << "Event: " << run << " " << luminosityBlock << " " << event << "\n";
      //cout << "fatJets: " << FatJet_pt[0] << " " << FatJet_eta[0] << " " << FatJet_msoftdrop[0] << " \n"; 
...
*/
      ...
      fatJet1_globalParT3_QCD       = FatJet_globalParT3_QCD[0] ; 	
      fatJet1_globalParT3_TopbWev    = FatJet_globalParT3_TopbWev[0] ;     
      fatJet1_globalParT3_TopbWmv    = FatJet_globalParT3_TopbWmv[0] ;     
      fatJet1_globalParT3_TopbWq     = FatJet_globalParT3_TopbWq[0] ; 	    
      fatJet1_globalParT3_TopbWqq    = FatJet_globalParT3_TopbWqq[0] ;     
      fatJet1_globalParT3_TopbWtauhv = FatJet_globalParT3_TopbWtauhv[0] ;  
      fatJet1_globalParT3_WvsQCD     = FatJet_globalParT3_WvsQCD[0] ; 	    
      fatJet1_globalParT3_XWW3q      = FatJet_globalParT3_XWW3q[0] ; 	    
      fatJet1_globalParT3_XWW4q      = FatJet_globalParT3_XWW4q[0] ; 	    
      fatJet1_globalParT3_XWWqqev    = FatJet_globalParT3_XWWqqev[0] ;     
      fatJet1_globalParT3_XWWqqmv    = FatJet_globalParT3_XWWqqmv[0] ;     
      fatJet1_globalParT3_Xbb        = FatJet_globalParT3_Xbb[0] ; 	    
      fatJet1_globalParT3_Xcc        = FatJet_globalParT3_Xcc[0] ; 	    
      fatJet1_globalParT3_Xcs        = FatJet_globalParT3_Xcs[0] ; 	    
      fatJet1_globalParT3_Xqq        = FatJet_globalParT3_Xqq[0] ; 	    
      fatJet1_globalParT3_Xtauhtaue  = FatJet_globalParT3_Xtauhtaue[0] ;   
      fatJet1_globalParT3_Xtauhtauh  = FatJet_globalParT3_Xtauhtauh[0] ;   
      fatJet1_globalParT3_Xtauhtaum  = FatJet_globalParT3_Xtauhtaum[0] ;   
      fatJet1_globalParT3_massCorrGeneric  = FatJet_globalParT3_massCorrGeneric[0] ; 
      fatJet1_globalParT3_massCorrX2p      = FatJet_globalParT3_massCorrX2p[0] ; 
      fatJet1_globalParT3_withMassTopvsQCD = FatJet_globalParT3_withMassTopvsQCD[0] ;
      fatJet1_globalParT3_withMassWvsQCD   = FatJet_globalParT3_withMassWvsQCD[0] ; 
      fatJet1_globalParT3_withMassZvsQCD   = FatJet_globalParT3_withMassZvsQCD[0] ; 
...
//      double btagMediumCut = 0.3033;     // PostEE
    ...
    if (nFatJet>1 && FatJet_pt[1] > 200 && FatJet_msoftdrop[1] >40){
      ...
      fatJet2_globalParT3_QCD       = FatJet_globalParT3_QCD[1] ; 	
      fatJet2_globalParT3_TopbWev    = FatJet_globalParT3_TopbWev[1] ;     
      fatJet2_globalParT3_TopbWmv    = FatJet_globalParT3_TopbWmv[1] ;     
      fatJet2_globalParT3_TopbWq     = FatJet_globalParT3_TopbWq[1] ; 	    
      fatJet2_globalParT3_TopbWqq    = FatJet_globalParT3_TopbWqq[1] ;     
      fatJet2_globalParT3_TopbWtauhv = FatJet_globalParT3_TopbWtauhv[1] ;  
      fatJet2_globalParT3_WvsQCD     = FatJet_globalParT3_WvsQCD[1] ; 	    
      fatJet2_globalParT3_XWW3q      = FatJet_globalParT3_XWW3q[1] ; 	    
      fatJet2_globalParT3_XWW4q      = FatJet_globalParT3_XWW4q[1] ; 	    
      fatJet2_globalParT3_XWWqqev    = FatJet_globalParT3_XWWqqev[1] ;     
      fatJet2_globalParT3_XWWqqmv    = FatJet_globalParT3_XWWqqmv[1] ;     
      fatJet2_globalParT3_Xbb        = FatJet_globalParT3_Xbb[1] ; 	    
      fatJet2_globalParT3_Xcc        = FatJet_globalParT3_Xcc[1] ; 	    
      fatJet2_globalParT3_Xcs        = FatJet_globalParT3_Xcs[1] ; 	    
      fatJet2_globalParT3_Xqq        = FatJet_globalParT3_Xqq[1] ; 	    
      fatJet2_globalParT3_Xtauhtaue  = FatJet_globalParT3_Xtauhtaue[1] ;   
      fatJet2_globalParT3_Xtauhtauh  = FatJet_globalParT3_Xtauhtauh[1] ;   
      fatJet2_globalParT3_Xtauhtaum  = FatJet_globalParT3_Xtauhtaum[1] ;   
      fatJet2_globalParT3_massCorrGeneric  = FatJet_globalParT3_massCorrGeneric[1] ; 
      fatJet2_globalParT3_massCorrX2p      = FatJet_globalParT3_massCorrX2p[1] ; 
      fatJet2_globalParT3_withMassTopvsQCD = FatJet_globalParT3_withMassTopvsQCD[1] ;
      fatJet2_globalParT3_withMassWvsQCD   = FatJet_globalParT3_withMassWvsQCD[1] ; 
      fatJet2_globalParT3_withMassZvsQCD   = FatJet_globalParT3_withMassZvsQCD[1] ; 
    ...
    if (nFatJet>2 && FatJet_pt[2] > 200 && FatJet_msoftdrop[2] >40){
      ...
      fatJet3_globalParT3_QCD       = FatJet_globalParT3_QCD[2] ; 	
      fatJet3_globalParT3_TopbWev    = FatJet_globalParT3_TopbWev[2] ;     
      fatJet3_globalParT3_TopbWmv    = FatJet_globalParT3_TopbWmv[2] ;     
      fatJet3_globalParT3_TopbWq     = FatJet_globalParT3_TopbWq[2] ; 	    
      fatJet3_globalParT3_TopbWqq    = FatJet_globalParT3_TopbWqq[2] ;     
      fatJet3_globalParT3_TopbWtauhv = FatJet_globalParT3_TopbWtauhv[2] ;  
      fatJet3_globalParT3_WvsQCD     = FatJet_globalParT3_WvsQCD[2] ; 	    
      fatJet3_globalParT3_XWW3q      = FatJet_globalParT3_XWW3q[2] ; 	    
      fatJet3_globalParT3_XWW4q      = FatJet_globalParT3_XWW4q[2] ; 	    
      fatJet3_globalParT3_XWWqqev    = FatJet_globalParT3_XWWqqev[2] ;     
      fatJet3_globalParT3_XWWqqmv    = FatJet_globalParT3_XWWqqmv[2] ;     
      fatJet3_globalParT3_Xbb        = FatJet_globalParT3_Xbb[2] ; 	    
      fatJet3_globalParT3_Xcc        = FatJet_globalParT3_Xcc[2] ; 	    
      fatJet3_globalParT3_Xcs        = FatJet_globalParT3_Xcs[2] ; 	    
      fatJet3_globalParT3_Xqq        = FatJet_globalParT3_Xqq[2] ; 	    
      fatJet3_globalParT3_Xtauhtaue  = FatJet_globalParT3_Xtauhtaue[2] ;   
      fatJet3_globalParT3_Xtauhtauh  = FatJet_globalParT3_Xtauhtauh[2] ;   
      fatJet3_globalParT3_Xtauhtaum  = FatJet_globalParT3_Xtauhtaum[2] ;   
      fatJet3_globalParT3_massCorrGeneric  = FatJet_globalParT3_massCorrGeneric[2] ; 
      fatJet3_globalParT3_massCorrX2p      = FatJet_globalParT3_massCorrX2p[2] ; 
      fatJet3_globalParT3_withMassTopvsQCD = FatJet_globalParT3_withMassTopvsQCD[2] ;
      fatJet3_globalParT3_withMassWvsQCD   = FatJet_globalParT3_withMassWvsQCD[2] ; 
      fatJet3_globalParT3_withMassZvsQCD   = FatJet_globalParT3_withMassZvsQCD[2] ;      
