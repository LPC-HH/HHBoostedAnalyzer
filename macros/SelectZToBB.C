...
void RunSelectHHTo4B(  std::vector<std::pair<std::vector<std::string>,std::string > > datafiles, std::vector<std::vector<std::pair<std::vector<std::string>,std::string > > > bkgfiles, std::vector<std::string> bkgLabels, std::vector<int> bkgColors, std::vector<float> bkgScaleFactors, int channelOption = 1, double totalLumi = 0, std::string label = "") {
  ...
  for(int i=0; i<int(inputfiles.size()); i++) {
    ...
    file->WriteTObject(histJet1DDB[i], Form("histJet1DDB_%s",processLabels[i].c_str()), "WriteDelete");
    file->WriteTObject(histJet1PNetXbb[i], Form("histJet1PNetXbb_%s",processLabels[i].c_str()), "WriteDelete");
    file->WriteTObject(histJet1Tau3OverTau2[i], Form("histJet1Tau3OverTau2_%s",processLabels[i].c_str()), "WriteDelete");
...
void SelectZToBB( int option = -1) {
  ...
  std::vector<std::string> bkgfiles_W_2016;
  std::vector<std::string> bkgfiles_Z_2016;  
  std::vector<std::string> bkgfiles_qcd_2016; 
  std::vector<std::string> bkgfiles_ttbar_2017;
  std::vector<std::string> bkgfiles_W_2017;
  std::vector<std::string> bkgfiles_Z_2017;  
  std::vector<std::string> bkgfiles_qcd_2017; 
  std::vector<std::string> bkgfiles_ttbar_2018;
  std::vector<std::string> bkgfiles_W_2018;
  std::vector<std::string> bkgfiles_Z_2018;  
  ...
  std::string dir = "/eos/cms/store/group/phys_susy/razor/Run2Analysis/HH/HHTo4BNtupler/20201117/option20/combined/";
  ...
  //2018 Data and MC
  //***********************************
  datafiles_2018.push_back(dir+"2018/JetHT_2018A.root");
  datafiles_2018.push_back(dir+"2018/JetHT_2018B.root");
  datafiles_2018.push_back(dir+"2018/JetHT_2018C.root");
  datafiles_2018.push_back(dir+"2018/JetHT_2018D.root");

  bkgfiles_ttbar_2018.push_back(dir+"2018/TTToHadronic_TuneCP5_13TeV-powheg-pythia8-combined_1pb_weighted.root");  
  bkgfiles_ttbar_2018.push_back(dir+"2018/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8-combined_1pb_weighted.root");  
 
  bkgfiles_W_2018.push_back(dir+"2018/WJetsToQQ_HT400to600_qc19_3j_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_W_2018.push_back(dir+"2018/WJetsToQQ_HT600to800_qc19_3j_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_W_2018.push_back(dir+"2018/WJetsToQQ_HT-800toInf_qc19_3j_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");

  bkgfiles_Z_2018.push_back(dir+"2018/ZJetsToQQ_HT400to600_qc19_4j_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_Z_2018.push_back(dir+"2018/ZJetsToQQ_HT600to800_qc19_4j_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_Z_2018.push_back(dir+"2018/ZJetsToQQ_HT800toInf_qc19_4j_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");

  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT200to300_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT300to500_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT500to700_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT700to1000_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT1500to2000_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
  bkgfiles_qcd_2018.push_back(dir+"2018/QCD_HT2000toInf_TuneCP5_13TeV-madgraphMLM-pythia8_1pb_weighted.root");
 
 

  //another vector to contain the different dataset years
  std::vector<std::pair<std::vector<std::string>,std::string > > bkgfiles_ttbar;
  std::vector<std::pair<std::vector<std::string>,std::string > > bkgfiles_W;
  std::vector<std::pair<std::vector<std::string>,std::string > > bkgfiles_Z;
  ...
  if (option == -1) {
    ...
    bkgfiles_W.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_W_2016 , "2016"));
    bkgfiles_Z.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_Z_2016 , "2016"));
    ...
    bkgfiles_W.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_W_2017 , "2017"));
    bkgfiles_Z.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_Z_2017 , "2017"));
    ...
    bkgfiles_W.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_W_2018 , "2018"));
    bkgfiles_Z.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_Z_2018 , "2018"));
  }
  if (option == 0) {
    datafiles.push_back(std::pair<std::vector<std::string> , std::string> ( datafiles_2016, "2016"));
    bkgfiles_qcd.push_back(std::pair<std::vector<std::string> , std::string>( bkgfiles_qcd_2016 , "2016"));
  ...
  bkgfiles.push_back(bkgfiles_W);
  bkgfiles.push_back(bkgfiles_Z);

  processLabels.push_back("QCD");
  processLabels.push_back("TTJets");  
  processLabels.push_back("W");
  processLabels.push_back("Z");
