...
void RunSelectHHTo4B(  std::vector<std::pair<std::vector<std::string>,std::string > > datafiles, std::vector<std::vector<std::pair<std::vector<std::string>,std::string > > > bkgfiles, std::vector<std::string> bkgLabels, std::vector<int> bkgColors, std::vector<float> bkgScaleFactors, int channelOption = 1, double totalLumi = 0, std::string label = "") {
  ...
  for (uint i=0; i < inputfiles.size(); ++i) {
	...
	tree->SetBranchAddress("puWeight",&pileupWeight);
	...
	for(UInt_t ientry=0; ientry < tree->GetEntries(); ientry++) {       	
	  ...
	  if (!isData) {	 
	    ...
	    if (processLabels[i] == "HH" || processLabels[i] == "HHkl0" || processLabels[i] == "HHkl0" || processLabels[i] == "HHkl0") {
	      myWeight = lumi * weight * xsecWeight * triggerEff3DWeight * pileupWeight * scaleFactors[i];
	  ...
	  if (channelOption == 1) {
	    ...
	    //if (processLabels[i] == "HH") cout << disc_v8p2  << " : " << fatJet2PNetXbb << "\n";
	    ...
	    // if (processLabels[i] == "HH") cout << "pass\n";
...
void SelectHHTo4B_PNetRegression( int option = -1) {
  ...
  std::string dir = "/eos/cms/store/group/phys_susy/razor/Run2Analysis/HH/HHTo4BNtupler/20210510_regression/option5/combined/BDT/Jet2Xbb0p8Skim/";
  //std::string dir = "/eos/cms/store/group/phys_susy/razor/Run2Analysis/HH/HHTo4BNtupler/20210310/option5/combined/BDT/";
  datafiles_2016.push_back(dir+"2016/JetHT_2016B-ver2_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2016.push_back(dir+"2016/JetHT_2016C_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2016.push_back(dir+"2016/JetHT_2016D_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2016.push_back(dir+"2016/JetHT_2016E_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2016.push_back(dir+"2016/JetHT_2016F_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2016.push_back(dir+"2016/JetHT_2016G_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2016.push_back(dir+"2016/JetHT_2016H_BDTs_Jet2Xbb0p8Skim.root");
  ...
  //2017 Data and MC
  //***********************************
  datafiles_2017.push_back(dir+"2017/JetHT_2017B_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2017.push_back(dir+"2017/JetHT_2017C_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2017.push_back(dir+"2017/JetHT_2017D_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2017.push_back(dir+"2017/JetHT_2017E_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2017.push_back(dir+"2017/JetHT_2017F_BDTs_Jet2Xbb0p8Skim.root");
  ...
  //2018 Data and MC
  //***********************************
  datafiles_2018.push_back(dir+"2018/JetHT_2018A_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2018.push_back(dir+"2018/JetHT_2018B_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2018.push_back(dir+"2018/JetHT_2018C_BDTs_Jet2Xbb0p8Skim.root");
  datafiles_2018.push_back(dir+"2018/JetHT_2018D_BDTs_Jet2Xbb0p8Skim.root");
...
//**********************************
//Signal Yields
//Input dir: /eos/cms/store/group/phys_susy/razor/Run2Analysis/HH/HHTo4BNtupler/20210510_regression/option5/combined/BDT/Jet2Xbb0p8Skim/
//**********************************
//Run2
//**********************************
// Total Sideband Data: 22
// Bkg Prediction From Sideband: 8
// Signal SM: 1.24877
// Signal kl0: 1.55826
// Signal kl2p45: 0.911306
// Signal kl5: 0.660237
//**********************************
//2016
//**********************************
...
//**********************************
//2017 --> this one is different
//**********************************
// Total Sideband Data: 11
// Bkg Prediction From Sideband: 6
// Signal SM: 0.396902
// Signal kl0: 0.476128
// Signal kl2p45: 0.307036
// Signal kl5: 0.186248
...
// Data Event: 305814 : 376980935 | 59.4074
// Data Event: 306422 : 206705829 | 50.5808
// Data Event: 306125 : 908719081 | 147.235
// Data Event: 306138 : 605214355 | 60.0021

//**********************************
//2018 --> this one is different
//**********************************
// Total Sideband Data: 14
// Bkg Prediction From Sideband: 6
// Signal SM: 0.50362
// Signal kl0: 0.609748
// Signal kl2p45: 0.357885
// Signal kl5: 0.284279
...
// Data Event: 321475 : 2626988847 | 71.0986
