...
for listfile in datasetList.keys():
    ...
    ###################################################
    os.system("tar vczf " + Analyzer_DIR + "/condor/analyzer_" + analysis + "_" + label + "/" + datasetName + "/code.tgz " + Analyzer_DIR + "/include/ " + Analyzer_DIR + "/src/ " + Analyzer_DIR + "/app/ " + Analyzer_DIR + "/Makefile " )
