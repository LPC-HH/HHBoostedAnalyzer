...
datasetList["nano/run3/2022/ttHto2B_M-125.list"] = [1, 1, "2022", "", 1]
...
datasetList["nano/run3/2022/Wto2Q-3Jets_HT-200to400.list"] = [1, 1, "2022", "", 1]
datasetList["nano/run3/2022/Wto2Q-3Jets_HT-400to600.list"] = [1, 1, "2022", "", 1]
datasetList["nano/run3/2022/Wto2Q-3Jets_HT-600to800.list"] = [1, 1, "2022", "", 1]
datasetList["nano/run3/2022/Wto2Q-3Jets_HT-800.list"] = [1, 1, "2022", "", 1]
...
datasetList["nano/run3/2022/WtoLNu-4Jets.list"] = [1, 1, "2022", "", 1]
...
datasetList["nano/run3/2022/Zto2Q-4Jets_HT-200to400.list"] = [1, 1, "2022", "", 1]
datasetList["nano/run3/2022/Zto2Q-4Jets_HT-400to600.list"] = [1, 1, "2022", "", 1]
datasetList["nano/run3/2022/Zto2Q-4Jets_HT-600to800.list"] = [1, 1, "2022", "", 1]
datasetList["nano/run3/2022/Zto2Q-4Jets_HT-800.list"] = [1, 1, "2022", "", 1]
...
datasetList["nano/run3/2022EE/ttHto2B_M-125.list"] = [1, 1, "2022EE", "", 1]
...
datasetList["nano/run3/2022EE/Wto2Q-3Jets_HT-400to600.list"] = [1, 1, "2022EE", "", 1]
datasetList["nano/run3/2022EE/Wto2Q-3Jets_HT-600to800.list"] = [1, 1, "2022EE", "", 1]
datasetList["nano/run3/2022EE/Wto2Q-3Jets_HT-800.list"] = [1, 1, "2022EE", "", 1]
...
datasetList["nano/run3/2022EE/WtoLNu-4Jets.list"] = [1, 1, "2022EE", "", 1]
...
datasetList["nano/run3/2022EE/Zto2Q-4Jets_HT-200to400.list"] = [1, 1, "2022EE", "", 1]
datasetList["nano/run3/2022EE/Zto2Q-4Jets_HT-400to600.list"] = [1, 1, "2022EE", "", 1]
datasetList["nano/run3/2022EE/Zto2Q-4Jets_HT-600to800.list"] = [1, 1, "2022EE", "", 1]
datasetList["nano/run3/2022EE/Zto2Q-4Jets_HT-800.list"] = [1, 1, "2022EE", "", 1]
...
datasetList["nano/run3/2023/ttHto2B_M-125.list"] = [1, 1, "2023", "", 1]
...
datasetList["nano/run3/2023/Wto2Q-3Jets_HT-200to400.list"] = [1, 1, "2023", "", 1]
datasetList["nano/run3/2023/Wto2Q-3Jets_HT-400to600.list"] = [1, 1, "2023", "", 1]
datasetList["nano/run3/2023/Wto2Q-3Jets_HT-600to800.list"] = [1, 1, "2023", "", 1]
datasetList["nano/run3/2023/Wto2Q-3Jets_HT-800.list"] = [1, 1, "2023", "", 1]
...
datasetList["nano/run3/2023/WtoLNu-4Jets.list"] = [1, 1, "2023", "", 1]
...
datasetList["nano/run3/2023/Zto2Q-4Jets_HT-200to400.list"] = [1, 1, "2023", "", 1]
datasetList["nano/run3/2023/Zto2Q-4Jets_HT-400to600.list"] = [1, 1, "2023", "", 1]
datasetList["nano/run3/2023/Zto2Q-4Jets_HT-600to800.list"] = [1, 1, "2023", "", 1]
datasetList["nano/run3/2023/Zto2Q-4Jets_HT-800.list"] = [1, 1, "2023", "", 1]
...
datasetList["nano/run3/2023BPix/ttHto2B_M-125.list"] = [1, 1, "2023BPix", "", 1]
...
datasetList["nano/run3/2023BPix/Wto2Q-3Jets_HT-200to400.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/Wto2Q-3Jets_HT-400to600.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/Wto2Q-3Jets_HT-600to800.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/Wto2Q-3Jets_HT-800.list"] = [1, 1, "2023BPix", "", 1]
...
datasetList["nano/run3/2023BPix/WtoLNu-4Jets.list"] = [1, 1, "2023BPix", "", 1]
...
datasetList["nano/run3/2023BPix/Zto2Q-4Jets_HT-200to400.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/Zto2Q-4Jets_HT-400to600.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/Zto2Q-4Jets_HT-600to800.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/Zto2Q-4Jets_HT-800.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/WW.list"] = [1, 1, "2023BPix", "", 1]
datasetList["nano/run3/2023BPix/WZ.list"] = [1, 1, "2023BPix", "", 1]


#2024 ntuples
datasetList["nano/run3/2024/EGamma0_Run2024C.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024D.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024E.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024F.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024G.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024H.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024I-v1.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma0_Run2024I-v2.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024C.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024D.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024E.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024F.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024G.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024H.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024I-v1.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/EGamma1_Run2024I-v2.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024C.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024D.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024E.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024F.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024G.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024H.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024I-v1.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET0_Run2024I-v2.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024C.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024D.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024E.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024F.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024G.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024H.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024I-v1.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/JetMET1_Run2024I-v2.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024C.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024D.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024E.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024F.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024G.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024H.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024I-v1.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon0_Run2024I-v2.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024C.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024D.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024E.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024F.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024G.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024H.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024I-v1.list"] = [1, 1, "2024", "", 1]
datasetList["nano/run3/2024/Muon1_Run2024I-v2.list"] = [1, 1, "2024", "", 1]

datasetList["nano/run3/2025/EGamma0_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma0_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma1_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma2_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/EGamma3_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET0_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/JetMET1_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025F.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon0_Run2025G.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025B.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025C-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025C-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025D.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025E.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025F.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025F-v1.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025F-v2.list"] = [1, 1, "2025", "", 1]
datasetList["nano/run3/2025/Muon1_Run2025G.list"] = [1, 1, "2025", "", 1]
