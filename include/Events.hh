...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   int* SubJet_nCHadrons   = new int[NSUBJET];   //[nSubJet]
    ...
    float* FatJet_globalParT_QCD0HF = new float[NFATJET];
    float* FatJet_globalParT_QCD1HF = new float[NFATJET];
    float* FatJet_globalParT_QCD2HF = new float[NFATJET];
    float* FatJet_globalParT_TopW = new float[NFATJET];
    float* FatJet_globalParT_TopbW = new float[NFATJET];
    float* FatJet_globalParT_TopbWev = new float[NFATJET];
    float* FatJet_globalParT_TopbWmv = new float[NFATJET];
    float* FatJet_globalParT_TopbWq = new float[NFATJET];
    float* FatJet_globalParT_TopbWqq = new float[NFATJET];
    float* FatJet_globalParT_TopbWtauhv = new float[NFATJET];
    float* FatJet_globalParT_Xbb = new float[NFATJET];
    float* FatJet_globalParT_XbbVsQCD = new float[NFATJET];
    float* FatJet_globalParT_Xcc = new float[NFATJET];
    float* FatJet_globalParT_Xcs = new float[NFATJET];
    float* FatJet_globalParT_Xgg = new float[NFATJET];
    float* FatJet_globalParT_Xqq = new float[NFATJET];
    float* FatJet_globalParT_Xtauhtaue = new float[NFATJET];
    float* FatJet_globalParT_Xtauhtauh = new float[NFATJET];
    float* FatJet_globalParT_Xtauhtaum = new float[NFATJET];
    float* FatJet_globalParT_massRes = new float[NFATJET];
    float* FatJet_globalParT_massVis = new float[NFATJET];
    float* FatJet_globalParT3_QCD        = new float[NFATJET];
    float* FatJet_globalParT3_TopbWev    = new float[NFATJET];
    float* FatJet_globalParT3_TopbWmv    = new float[NFATJET];
    float* FatJet_globalParT3_TopbWq     = new float[NFATJET];	    
    float* FatJet_globalParT3_TopbWqq    = new float[NFATJET];
    float* FatJet_globalParT3_TopbWtauhv = new float[NFATJET];
    float* FatJet_globalParT3_WvsQCD     = new float[NFATJET];	    
    float* FatJet_globalParT3_XWW3q      = new float[NFATJET];	    
    float* FatJet_globalParT3_XWW4q      = new float[NFATJET];	    
    float* FatJet_globalParT3_XWWqqev    = new float[NFATJET];
    float* FatJet_globalParT3_XWWqqmv    = new float[NFATJET];
    float* FatJet_globalParT3_Xbb        = new float[NFATJET];
    float* FatJet_globalParT3_Xcc        = new float[NFATJET];
    float* FatJet_globalParT3_Xcs        = new float[NFATJET];
    float* FatJet_globalParT3_Xqq        = new float[NFATJET];
    float* FatJet_globalParT3_Xtauhtaue  = new float[NFATJET];
    float* FatJet_globalParT3_Xtauhtauh  = new float[NFATJET];
    float* FatJet_globalParT3_Xtauhtaum  = new float[NFATJET]; 
    float* FatJet_globalParT3_massCorrGeneric  = new float[NFATJET];
    float* FatJet_globalParT3_massCorrX2p      = new float[NFATJET];
    float* FatJet_globalParT3_withMassTopvsQCD = new float[NFATJET];
    float* FatJet_globalParT3_withMassWvsQCD   = new float[NFATJET];
    float* FatJet_globalParT3_withMassZvsQCD   = new float[NFATJET];  
...
//   int*   TrigObj_id         = new int[NTRIGOBJ];   //[nTrigObj]
   ...
   Bool_t          L1simulation_step = 0;
   Bool_t          HLTriggerFirstPath = 0;
   Bool_t          HLTriggerFinalPath = 0;
   Bool_t          HLT_IsoMu27 = 0;
   Bool_t          HLT_Mu50 = 0;
   Bool_t          HLT_Ele32_WPTight_Gsf = 0;
   Bool_t          HLT_AK8PFJet140 = 0;
   Bool_t          HLT_AK8PFJet230_SoftDropMass40 = 0;
   Bool_t          HLT_AK8PFJet230_SoftDropMass40_PFAK8ParticleNetBB0p35 = 0;
   Bool_t          HLT_AK8PFJet250_SoftDropMass40_PFAK8ParticleNetBB0p35 = 0;
   Bool_t          HLT_AK8PFJet275_SoftDropMass40_PFAK8ParticleNetBB0p35 = 0;
   Bool_t          HLT_AK8PFJet230_SoftDropMass40_PNetBB0p06 = 0;
   Bool_t          HLT_AK8PFJet250_SoftDropMass40_PNetBB0p06 = 0;
   Bool_t          HLT_AK8PFJet275_SoftDropMass40_PNetBB0p06 = 0;
   Bool_t          HLT_IsoMu50_AK8PFJet230_SoftDropMass40 = 0;
   Bool_t          HLT_IsoMu50_AK8PFJet230_SoftDropMass40_PFAK8ParticleNetBB0p35 = 0;
   Bool_t          HLT_IsoMu50_AK8PFJet230_SoftDropMass40_PNetBB0p06 = 0;
   Bool_t          HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet230_SoftDropMass40 = 0;
   Bool_t          HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet230_SoftDropMass40_PFAK8ParticleNetBB0p35 = 0;
   Bool_t          HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet230_SoftDropMass40_PNetBB0p06 = 0;
   Bool_t          HLT_AK8DiPFJet250_250_MassSD30 = 0;
   Bool_t          HLT_AK8DiPFJet250_250_MassSD50 = 0;
   Bool_t          HLT_AK8PFJet425_SoftDropMass40 = 0;
   ...
   TBranch        *b_FatJet_globalParT_QCD0HF;   
   TBranch        *b_FatJet_globalParT_QCD1HF;   
   TBranch        *b_FatJet_globalParT_QCD2HF;   
   TBranch        *b_FatJet_globalParT_TopW;   
   TBranch        *b_FatJet_globalParT_TopbW;   
   TBranch        *b_FatJet_globalParT_TopbWev;   
   TBranch        *b_FatJet_globalParT_TopbWmv;   
   TBranch        *b_FatJet_globalParT_TopbWq;   
   TBranch        *b_FatJet_globalParT_TopbWqq;   
   TBranch        *b_FatJet_globalParT_TopbWtauhv;   
   TBranch        *b_FatJet_globalParT_Xbb;   
   TBranch        *b_FatJet_globalParT_XbbVsQCD;   
   TBranch        *b_FatJet_globalParT_Xcc;   
   TBranch        *b_FatJet_globalParT_Xcs;   
   TBranch        *b_FatJet_globalParT_Xgg;   
   TBranch        *b_FatJet_globalParT_Xqq;   
   TBranch        *b_FatJet_globalParT_Xtauhtaue;   
   TBranch        *b_FatJet_globalParT_Xtauhtauh;   
   TBranch        *b_FatJet_globalParT_Xtauhtaum;   
   TBranch        *b_FatJet_globalParT_massRes;   
   TBranch        *b_FatJet_globalParT_massVis;
...
void Events::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("FatJet_globalParT_QCD0HF", FatJet_globalParT_QCD0HF, &b_FatJet_globalParT_QCD0HF);
   fChain->SetBranchAddress("FatJet_globalParT_QCD1HF", FatJet_globalParT_QCD1HF, &b_FatJet_globalParT_QCD1HF);
   fChain->SetBranchAddress("FatJet_globalParT_QCD2HF", FatJet_globalParT_QCD2HF, &b_FatJet_globalParT_QCD2HF);
   fChain->SetBranchAddress("FatJet_globalParT_TopW", FatJet_globalParT_TopW, &b_FatJet_globalParT_TopW);
   fChain->SetBranchAddress("FatJet_globalParT_TopbW", FatJet_globalParT_TopbW, &b_FatJet_globalParT_TopbW);
   fChain->SetBranchAddress("FatJet_globalParT_TopbWev", FatJet_globalParT_TopbWev, &b_FatJet_globalParT_TopbWev);
   fChain->SetBranchAddress("FatJet_globalParT_TopbWmv", FatJet_globalParT_TopbWmv, &b_FatJet_globalParT_TopbWmv);
   fChain->SetBranchAddress("FatJet_globalParT_TopbWq", FatJet_globalParT_TopbWq, &b_FatJet_globalParT_TopbWq);
   fChain->SetBranchAddress("FatJet_globalParT_TopbWqq", FatJet_globalParT_TopbWqq, &b_FatJet_globalParT_TopbWqq);
   fChain->SetBranchAddress("FatJet_globalParT_TopbWtauhv", FatJet_globalParT_TopbWtauhv, &b_FatJet_globalParT_TopbWtauhv);
   fChain->SetBranchAddress("FatJet_globalParT_Xbb", FatJet_globalParT_Xbb, &b_FatJet_globalParT_Xbb);
   fChain->SetBranchAddress("FatJet_globalParT_XbbVsQCD", FatJet_globalParT_XbbVsQCD, &b_FatJet_globalParT_XbbVsQCD);
   fChain->SetBranchAddress("FatJet_globalParT_Xcc", FatJet_globalParT_Xcc, &b_FatJet_globalParT_Xcc);
   fChain->SetBranchAddress("FatJet_globalParT_Xcs", FatJet_globalParT_Xcs, &b_FatJet_globalParT_Xcs);
   fChain->SetBranchAddress("FatJet_globalParT_Xgg", FatJet_globalParT_Xgg, &b_FatJet_globalParT_Xgg);
   fChain->SetBranchAddress("FatJet_globalParT_Xqq", FatJet_globalParT_Xqq, &b_FatJet_globalParT_Xqq);
   fChain->SetBranchAddress("FatJet_globalParT_Xtauhtaue", FatJet_globalParT_Xtauhtaue, &b_FatJet_globalParT_Xtauhtaue);
   fChain->SetBranchAddress("FatJet_globalParT_Xtauhtauh", FatJet_globalParT_Xtauhtauh, &b_FatJet_globalParT_Xtauhtauh);
   fChain->SetBranchAddress("FatJet_globalParT_Xtauhtaum", FatJet_globalParT_Xtauhtaum, &b_FatJet_globalParT_Xtauhtaum);
   fChain->SetBranchAddress("FatJet_globalParT_massRes", FatJet_globalParT_massRes, &b_FatJet_globalParT_massRes);
   fChain->SetBranchAddress("FatJet_globalParT_massVis", FatJet_globalParT_massVis, &b_FatJet_globalParT_massVis);
